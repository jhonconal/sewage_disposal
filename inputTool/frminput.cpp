...
void frmInput::showParentCenter(QWidget *parentFrm)
{
...
void frmInput::InitForm()
{
    ...
    IconHelper::Instance()->setButtonIcon(ui->btnClose,QChar(0xf08b),50);
    IconHelper::Instance()->setButtonIcon(ui->btnPre,QChar(0xf053),40);
    IconHelper::Instance()->setButtonIcon(ui->btnNext,QChar(0xf054),40);
    IconHelper::Instance()->setLabelIcon(ui->keyBoardLabel,QChar(0xf11c),60);
    IconHelper::Instance()->setButtonIcon(ui->btnSpace,QChar(0xf00a),60);
    IconHelper::Instance()->setButtonIcon(ui->btnDelete,QChar(0xf177),60);
    QDesktopWidget w;
...
void frmInput::changeType(QString type)
{
    if (type == "max") {
        changeLetter(true);
        ui->btnType->setText("Shift");
        ui->labInfo->setText("Upper");
